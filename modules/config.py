...
class Config:
    ...
    def print_config_recap(self):
        ...
        print(f" - Unicode Replacement Process: {'Enabled' if replacements_on else 'Disabled'}")
        ...
        print(f" - GPT Suggestions Option: {'Activated' if gpt_suggestions else 'Deactivated'}")
