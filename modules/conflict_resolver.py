...
class ConflictResolver:
    ...
    def detect_and_resolve_conflicts(self):
        ...
        """
        conflicts = {aw: (ms, self.user_solutions[aw]) for aw, ms in self.machine_solutions.items()
        ...
        for aw, (ms, us) in conflicts.items():
            ...
            decision = input("Enter 'M' to keep the Machine Solution, 'U' to keep the User Solution, or 'S' to skip: ").upper()
